...
<body>
    ...
    <form method="GET" class="filter-form">
        <label for="complaint_type">Filter by Complaint Type:</label>
    ...
    <div class="container">
        ...
        // Get selected complaint type from the query string
        $complaint_type = isset($_GET['complaint_type']) ? $_GET['complaint_type'] : '';

        // Prepare the SQL query
        $sql = "SELECT * FROM complaints";
        if ($complaint_type) {
            $sql .= " WHERE complaint_type = '" . mysqli_real_escape_string($conn, $complaint_type) . "'";
        }
