...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Update users table
    $update_users_sql = "UPDATE users SET email='$new_email', phno='$new_phone', address='$new_address', password=' $new_password ' WHERE name='$name'";
    
    // Update login table using old email
    $update_login_sql = "UPDATE login SET email='$new_email',password=' $new_password ' WHERE email='$old_email'";
